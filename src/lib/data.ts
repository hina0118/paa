...
export const emailData: Email[] = [
  {
    ...
    preview: "お疲れ様です。先日お話しした新規プロジェクトの件ですが、順調に進んでおります。来週のミーティングで詳細を...",
  ...
  },
  {
    ...
    subject: "明日の会議の件",
    preview: "明日の会議ですが、時間が1時間繰り上がりまして、14時からとなります。ご確認お願いします...",
  ...
  },
  {
    ...
    subject: "Re: 見積書の件",
    preview: "見積書を確認いたしました。いくつか質問がありますので、お時間のある時にお電話いただけますでしょうか...",
  ...
  },
  {
    ...
    subject: "週末のイベントについて",
    preview: "こんにちは!週末のイベントの参加者リストを送付します。全員で15名の参加予定となっております...",
  ...
  },
  {
    ...
    preview: "システムメンテナンスを以下の日程で実施いたします。メンテナンス中はサービスをご利用いただけません...",
  ...
  },
  {
    ...
    subject: "資料の共有",
    preview: "お疲れ様です。先日のプレゼンテーション資料を共有いたします。ご確認の上、フィードバックをいただけると...",
  ...
  },
  {
    ...
    subject: "新年会の出欠確認",
    preview: "新年会の日程が決まりましたので、出欠のご確認をお願いいたします。1月20日(土)18時から...",
  ...
  },
  {
    ...
    subject: "契約書のドラフト",
    preview: "契約書のドラフトを作成しましたので、ご確認をお願いいたします。修正点がございましたら...",
  ...
  },
  {
    ...
    subject: "研修資料について",
    preview: "来月の研修で使用する資料の準備状況を確認させていただきたく、ご連絡いたしました...",
  ...
  },
  {
    ...
    subject: "お礼とご報告",
    preview: "先日はお忙しい中、お時間をいただきありがとうございました。ご相談させていただいた件につきまして...",
