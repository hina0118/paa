...
| 領域 | カバレッジ | 目標 | 状態 | テスト数 |
|------|-----------|------|------|---------|
| **バックエンド（Rust）** | 65.39% | 85% | 🎯 順調 | 84件 |
| **フロントエンド（React）** | 93.60% | 85% | ✅ 目標達成! | 122件 |
| **全体（推定）** | ~77-79% | 85% | 🔄 順調 | 206件 |
...
| 指標 | カバレッジ | 詳細 |
|------|-----------|------|
| **行カバレッジ** | 65.39% | 1696行中587行未カバー |
| **関数カバレッジ** | 66.67% | 168関数中56関数未カバー |
| **リージョンカバレッジ** | 64.53% | 2244リージョン中796未カバー |

### 改善履歴（2026-01-18更新）

- 行カバレッジ: 36.13% → 53.11% → 57.13% → **65.39%** (+29.26%)
- 関数カバレッジ: 34.65% → 54.81% → 59.46% → **66.67%** (+32.02%)
- リージョンカバレッジ: 32.11% → 51.48% → 56.14% → **64.53%** (+32.42%)
- テスト数: 17件 → 54件 → 67件 → **84件** (+67件)
...
| **2026-01-18 (最新)** | **65.39%** | **93.60%** | **~77-79%** | **206件** | **モックテスト導入完了** 🎯 |
